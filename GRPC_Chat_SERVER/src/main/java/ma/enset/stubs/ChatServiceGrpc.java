...
public final class ChatServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ma.enset.stubs.Chat.ChatMessage,
      ma.enset.stubs.Chat.ChatMessageFromServer> getSendChatMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendChatMessage",
      requestType = ma.enset.stubs.Chat.ChatMessage.class,
      responseType = ma.enset.stubs.Chat.ChatMessageFromServer.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<ma.enset.stubs.Chat.ChatMessage,
      ma.enset.stubs.Chat.ChatMessageFromServer> getSendChatMessageMethod() {
    io.grpc.MethodDescriptor<ma.enset.stubs.Chat.ChatMessage, ma.enset.stubs.Chat.ChatMessageFromServer> getSendChatMessageMethod;
      ...
      synchronized (ChatServiceGrpc.class) {
        if ((getSendChatMessageMethod = ChatServiceGrpc.getSendChatMessageMethod) == null) {
          ChatServiceGrpc.getSendChatMessageMethod = getSendChatMessageMethod = 
              io.grpc.MethodDescriptor.<ma.enset.stubs.Chat.ChatMessage, ma.enset.stubs.Chat.ChatMessageFromServer>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "ChatService", "SendChatMessage"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.enset.stubs.Chat.ChatMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.enset.stubs.Chat.ChatMessageFromServer.getDefaultInstance()))
  ...
  public static abstract class ChatServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<ma.enset.stubs.Chat.ChatMessage> sendChatMessage(
        io.grpc.stub.StreamObserver<ma.enset.stubs.Chat.ChatMessageFromServer> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                ma.enset.stubs.Chat.ChatMessage,
                ma.enset.stubs.Chat.ChatMessageFromServer>(
